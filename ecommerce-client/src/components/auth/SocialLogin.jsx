    ...
    <div className="grid grid-cols-3 gap-3">
      {socialProviders.map((provider) => (
        <button
          ...
          disabled={isLoading}
          className={`flex items-center justify-center py-2 px-4 rounded-lg transition-colors ${provider.bgColor} ${provider.textColor} ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
          {provider.icon}
