    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[50vh] min-h-[400px] bg-cover bg-center bg-no-repeat flex items-center justify-center"
        ...
        <div className="relative text-center text-white px-4">
          <div className="inline-block px-4 py-1 bg-emerald-500/20 backdrop-blur-sm rounded-full text-sm mb-4 border border-emerald-400/30">
            👖 Premium Trousers
          </div>
          <h1 className="text-6xl md:text-7xl font-light mb-4 tracking-wide">Men's Trousers</h1>
          <p className="text-xl max-w-2xl mx-auto">Tailored precision for the modern gentleman</p>
        </div>
      </div>
