    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[50vh] min-h-[400px] bg-cover bg-center bg-no-repeat flex items-center justify-center"
        ...
        <div className="relative text-center text-white px-4">
          ...
          <h1 className="text-6xl md:text-7xl font-light mb-4 tracking-wide">Men's Jackets</h1>
          <p className="text-xl max-w-2xl mx-auto">Premium outerwear crafted for style and warmth</p>
        </div>
      </div>
