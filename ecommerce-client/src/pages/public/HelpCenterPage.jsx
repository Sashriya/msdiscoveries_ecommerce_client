  ...
  return (
    <div className="bg-white min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-5xl font-light text-center mb-8">Help Center</h1>
        ...
        <div className="mt-8 text-center"><Link to="/contact" className="text-black underline">Contact Support →</Link></div>
      </div>
    </div>
  );
};
