...
const JacketsPage = () => {
  ...
  useEffect(() => {
    const jacketsProducts = [
      { 
        id: 1, 
        name: 'Structural Cropped Twill Jacket', 
      ...
      { 
        id: 2, 
        name: 'Asymmetric Coat Wool Overlayer', 
        brand: 'THEKOUR ATELIER',
        price: 299.99, 
      ...
      { 
        id: 3, 
        name: 'Geometric Sharp Tailored Blazer Shell', 
        brand: 'THEKOUR ATELIER',
        price: 169.99, 
      ...
      { 
        id: 4, 
        name: 'Minimalist Linear Utility Trench', 
        brand: 'THEKOUR ATELIER',
        price: 219.99, 
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[50vh] min-h-[400px] bg-cover bg-center bg-no-repeat flex items-center justify-center"
        ...
        <div className="relative text-center text-white px-4">
          ...
          <h1 className="text-6xl md:text-7xl font-light mb-4 tracking-wide">Outerwear</h1>
          <p className="text-xl max-w-2xl mx-auto">Elevate your style with our premium jacket collection</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {['Blazer', 'Trench', 'Leather', 'Puffer'].map((type) => (
            <Link 
              key={type} 
              to={`/women/jackets/${type.toLowerCase()}`}
            ...
            >
              ...
              <img 
                src={`https://images.unsplash.com/photo-${type === 'Blazer' ? '1591047139829-d91aecb6caea' : type === 'Trench' ? '1548036328-c9fa89d128fa' : type === 'Leather' ? '1551028719-00167b16eac5' : '1539533113208-f6df8cc8b543'}?w=400&h=200&fit=crop`}
                alt={type}
      ...
      <div className="max-w-7xl mx-auto px-4 pb-16">
        <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Essential layers for every season</p>
          </div>
