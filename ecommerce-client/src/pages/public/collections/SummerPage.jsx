...
const SummerPage = () => {
  ...
  useEffect(() => {
    const summerProducts = [
      { 
        id: 1, 
        name: 'Raw Linen Relaxed Silhouette', 
      ...
      { 
        id: 2, 
        name: 'Breathable Sharp Cut Shirt', 
        brand: 'THEKOUR ATELIER',
        price: 59.99, 
        originalPrice: 89.99, 
      ...
      { 
        id: 3, 
        name: 'Unstructured Lightweight Overlayer', 
        brand: 'THEKOUR ATELIER',
        price: 129.99, 
      ...
      { 
        id: 4, 
        name: 'Lightweight Wide-Leg Trouser', 
        brand: 'THEKOUR ATELIER',
        price: 79.99, 
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[50vh] min-h-[400px] bg-cover bg-center bg-no-repeat flex items-center justify-center"
        ...
        <div className="relative text-center text-white px-4">
          ...
          <h1 className="text-6xl md:text-7xl font-light mb-4 tracking-wide">Summer Collection</h1>
          <p className="text-xl max-w-2xl mx-auto">Embrace the warmth with our breezy summer essentials</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="text-sm text-gray-500">
          ...
          <span className="text-black ml-1">Summer Collection</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-16">
        <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
          <div>
            <h2 className="text-3xl font-light">Sun-Drenched Staples</h2>
            <p className="text-gray-500 text-sm mt-1">Lightweight, breathable, and effortlessly stylish</p>
          </div>
