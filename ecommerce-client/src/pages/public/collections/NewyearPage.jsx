...
const NewYearPage = () => {
  ...
  useEffect(() => {
    const newYearProducts = [
      { id: 1, name: 'Premium Midnight Satin Piece', brand: 'THEKOUR ATELIER', price: 89.99, originalPrice: 129.99, image: 'https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=400&h=500&fit=crop', category: 'Party Wear', badge: 'Limited', color: 'Black', rating: 4.9 },
      { id: 2, name: 'Signature Sharp Tailored Blazer', brand: 'THEKOUR ATELIER', price: 59.99, originalPrice: 89.99, image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400&h=500&fit=crop', category: 'Blazers', badge: 'Best Seller', color: 'Navy', rating: 4.8 },
      ...
      { id: 4, name: 'Limited Edition Silk Trouser', brand: 'THEKOUR ATELIER', price: 79.99, originalPrice: 119.99, image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=500&fit=crop', category: 'Bottoms', badge: '', color: 'Silver', rating: 4.6 },
      { id: 5, name: 'Sequin Party Dress', brand: 'THEKOUR ATELIER', price: 149.99, originalPrice: 229.99, image: 'https://images.unsplash.com/photo-1539008835657-9e8e9680c956?w=400&h=500&fit=crop', category: 'Dresses', badge: 'Limited', color: 'Gold', rating: 4.9 },
      { id: 6, name: 'Celebration Heels', brand: 'THEKOUR ATELIER', price: 89.99, originalPrice: 139.99, image: 'https://images.unsplash.com/photo-1549298916-f52d724204b4?w=400&h=500&fit=crop', category: 'Footwear', badge: 'Trending', color: 'Silver', rating: 4.8 },
    ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="text-sm text-gray-500"><Link to="/" className="hover:text-black">Home</Link> / <Link to="/collections" className="hover:text-black ml-1">Collections</Link> / <span className="text-black ml-1">New Year Collection</span></div>
      </div>
