...
const NewYearPage = () => {
  ...
  useEffect(() => {
    const newYearProducts = [
      { 
        id: 1, 
        name: 'Premium Midnight Satin Gown', 
      ...
      { 
        id: 2, 
        name: 'Signature Sharp Tailored Blazer', 
        brand: 'THEKOUR ATELIER',
        price: 159.99, 
      ...
      { 
        id: 3, 
        name: 'Essential Metallic Accent Layer', 
        brand: 'THEKOUR ATELIER',
        price: 129.99, 
      ...
      { 
        id: 4, 
        name: 'Limited Edition Silk Trouser', 
        brand: 'THEKOUR ATELIER',
        price: 89.99, 
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[50vh] min-h-[400px] bg-cover bg-center bg-no-repeat flex items-center justify-center"
           style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=1920&h=600&fit=crop)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="text-sm text-gray-500">
          ...
          <span className="text-black ml-1">New Year Collection</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-16">
        <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
          <div>
            <h2 className="text-3xl font-light">Party Perfect</h2>
            <p className="text-gray-500 text-sm mt-1">Shine bright in our celebratory styles</p>
          </div>
